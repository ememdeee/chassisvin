...
const tabs: Tab[] = [
  { id: 'odometer', tab:' Odometer Reading',title: 'Quick, Accurate VIN Checks & Odometer Verification', content: 'Get accurate odometer readings and uncover essential vehicle history with ChassisVIN free VIN check. Our easy-to-use VIN lookup provides precise data on mileage, previous ownership, and more, helping you verify a vehicle condition and value with confidence. Enjoy a fast, reliable way to understand any car full chassis history.', icon: <Eye />, image: '/OdometerReading.webp', alt: 'Odometer Reading Visualization' },
  { id: 'ownership', tab: 'Ownership History',title: 'Unlock Ownership History with a Free, Reliable VIN Lookup for Clear Vehicle Insights', content: 'Discover detailed ownership history quickly with ChassisVIN free VIN check tool. Our VIN lookup service gives you easy access to past ownership records, helping you understand a vehicle full background before you buy. Check today for an informed, transparent view of any vehicle journey from one owner to the next.', icon: <Home />, image: '/Ownership.webp', alt: 'Ownership History Visualization' },
  { id: 'photos', tab: 'Auction Photo',title: 'View Auction Photos Instantly with a Free VIN Lookup for Transparent Vehicle Details', content: 'Access auction photos effortlessly with ChassisVin free VIN check tool, offering you a clear visual history of any vehicle. Our VIN lookup service provides detailed auction images, giving you valuable insights into a car past condition and helping you make informed purchasing choices. See what lies beneath the surface today.', icon: <Camera />, image: '/AuctionSales.webp', alt: 'Auction Sales Photos' },
  { id: 'damage', tab: 'Damage Check',title: 'Get Comprehensive Damage Checks with a Free VIN Lookup for Informed Vehicle Purchases', content: 'Ensure peace of mind with ChassisVIN free VIN check service, providing thorough damage checks for any vehicle. Our VIN lookup tool offers detailed insights into past incidents, helping you uncover potential issues before making a purchase. Start your search today to make confident decisions backed by accurate damage history information.', icon: <Hammer />, image: '/AccidentDamageHistory.webp', alt: 'Accident and Damage History Visualization' },
