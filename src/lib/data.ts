...
//   sample export const autoData: Make[] = [
//     {
//       name: "Toyota",
//       models: [
//         {
...
//   ];
  export const autoData: Make[] = [
    ...
    },
    {
        ...
        "models": [
            ...
            {
                "name": "Silverado 1500 Hybrid Classic",
                "years": [
                    {
                        "year": 2007
                    }
            ...
            {
                "name": "Silverado 1500 SS Classic",
                "years": [
                    {
                        "year": 2007
                    }
    ...
    },
    {
        ...
        "models": [
            ...
            {
                "name": "Sierra 1500 Hybrid Classic",
                "years": [
                    {
                        "year": 2007
                    }
  ...
  export function getMake(make: string): Make | undefined {
    return autoData.find(m => m.name.toLowerCase() === make.toLowerCase());
  }
  
  export function getModel(make: string, model: string): Model | undefined {
    const makeData = getMake(make);
    return makeData?.models.find(m => m.name.toLowerCase() === model.toLowerCase());
  }
  
  export function getYear(make: string, model: string, year: number): Year | undefined {
    const modelData = getModel(make, model);
    return modelData?.years.find(y => y.year === year);
  }
